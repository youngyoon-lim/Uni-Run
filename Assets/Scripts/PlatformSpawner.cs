...
public class PlatformSpawner : MonoBehaviour {
    ...
    void Start() {
        ...
        {
            //platformPrefab을 원복으로 새 발판을 poolPosition 위치에 복제 생성
            //생성된 발판ㅇ르 platforms 배열에 할당
    ...
    void Update() {
        ...
        {
            // 기록된 마지막 배치 시점ㅇ르 현재 시점으로 갱신
            lastSpawnTime = Time.time;

            // 다음배치까지의 시간 간격을 timebetSpanMin, timeBetSpawnMax 사이에서 랜덤설정
